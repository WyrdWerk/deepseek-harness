...
- **Configured DeepSeek gateways receive the id** — the provider adapter sends the stable header to its resolved `baseURL`, including deployment overrides, independently of telemetry sharing mode.
