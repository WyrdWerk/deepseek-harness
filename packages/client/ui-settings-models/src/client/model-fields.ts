/**
 * Shared model-catalog parse, format, and validation helpers.
 * Kept out of UI components so ProviderEditor and CustomProviderCard
 * do not import a React editor for field logic.
 */
