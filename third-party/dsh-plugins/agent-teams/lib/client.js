window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yash/Agent/project/deepseek-harness/third-party/dsh-plugins/agent-teams/src/client/AgentTeamsCard.module.css.mjs
		const css$1 = "._7tzHJG_root{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;width:100%;min-width:0;padding:10px 12px;display:flex}._7tzHJG_head{align-items:center;gap:8px;min-width:0;display:flex}._7tzHJG_leadAvatar{border:1px solid var(--dsw-alias-line-strong);object-fit:cover;background:#0b1d33;border-radius:50%;flex:none;width:24px;height:24px}._7tzHJG_teamName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}._7tzHJG_memberCount{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;margin-left:auto;font-size:11px;line-height:16px}._7tzHJG_panelButton{border:1px solid var(--dsw-alias-line-strong);background:var(--dsw-alias-bg-module);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;flex:none;padding:2px 8px;font-size:10.5px;font-weight:600;line-height:16px;transition:border-color .12s,color .12s}._7tzHJG_panelButton:hover{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}._7tzHJG_panelButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._7tzHJG_members{flex-wrap:wrap;gap:6px;min-width:0;display:flex}._7tzHJG_member{border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);max-width:160px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:5px;padding:3px 8px 3px 3px;font-size:11px;font-weight:500;line-height:16px;transition:border-color .12s,background-color .12s;display:inline-flex}._7tzHJG_member:hover{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-fill-neutral)}._7tzHJG_member:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._7tzHJG_memberArt{border:1px solid var(--dsw-alias-line-strong);object-fit:cover;background:#0b1d33;border-radius:50%;width:20px;height:20px}._7tzHJG_memberInitial{background:var(--dsw-alias-bg-fill-business);width:20px;height:20px;color:var(--dsw-alias-label-on-fill);border-radius:50%;justify-content:center;align-items:center;font-size:10px;font-weight:600;line-height:20px;display:inline-flex}._7tzHJG_memberName{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}";
		...
		var AgentTeamsCard_module_css_default = {
			"head": "_7tzHJG_head",
			"leadAvatar": "_7tzHJG_leadAvatar",
			"member": "_7tzHJG_member",
			"memberArt": "_7tzHJG_memberArt",
			"memberCount": "_7tzHJG_memberCount",
			"memberInitial": "_7tzHJG_memberInitial",
			"memberName": "_7tzHJG_memberName",
			"members": "_7tzHJG_members",
			"panelButton": "_7tzHJG_panelButton",
			"root": "_7tzHJG_root",
			"teamName": "_7tzHJG_teamName"
		};
		//#endregion
		...
		* (historical session review). */
		...
		//#endregion
		//#region \0dsh-css:/home/yash/Agent/project/deepseek-harness/third-party/dsh-plugins/agent-teams/src/client/ActivityPanel.module.css.mjs
		const css = "html{--agent-teams-panel-width:388px;--agent-teams-panel-right:calc(18px + var(--dsh-sidebar-width,0px));--agent-teams-panel-gap:14px;--agent-teams-panel-shift:calc(var(--agent-teams-panel-width) + 18px + var(--agent-teams-panel-gap))}html[data-agent-teams-panel-open] [data-phase=active]{box-sizing:border-box;padding-right:var(--agent-teams-panel-shift)}[data-phase=active]{will-change:padding-right;transition:padding-right .36s cubic-bezier(.22,1,.36,1)}.AryulW_badge{top:64px;right:var(--agent-teams-panel-right);z-index:2147483000;box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 92%, transparent);backdrop-filter:blur(16px);height:34px;box-shadow:0 8px 28px color-mix(in srgb, var(--dsw-alias-label-primary) 14%, transparent);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border-radius:999px;align-items:center;gap:7px;padding:0 12px;font-size:12px;font-weight:600;line-height:20px;transition:border-color .15s,transform .12s;display:inline-flex;position:fixed}.AryulW_badge:hover{border-color:var(--dsw-alias-line-strong);transform:translateY(-1px)}.AryulW_badge:active{transform:translateY(0)scale(.98)}.AryulW_badge:focus-visible,.AryulW_closeButton:focus-visible,.AryulW_memberRow:focus-visible,.AryulW_taskNode:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.AryulW_badgeDot,.AryulW_panelDot{background:var(--dsw-alias-label-tertiary);border-radius:50%;width:7px;height:7px}.AryulW_badgeDot[data-busy=true],.AryulW_panelDot[data-busy=true]{background:var(--dsw-alias-state-business-primary);animation:1.25s ease-in-out infinite AryulW_agentTeamsPulse}.AryulW_badgeCount,.AryulW_memberCount,.AryulW_teamStats,.AryulW_stageLabel,.AryulW_taskId{font-variant-numeric:tabular-nums}.AryulW_panel{top:64px;right:var(--agent-teams-panel-right);z-index:2147483000;width:min(var(--agent-teams-panel-width), calc(100vw - 24px));box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-line-strong) 58%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-module-platform) 95%, transparent);backdrop-filter:blur(20px)saturate(1.08);max-height:70dvh;box-shadow:0 12px 32px color-mix(in srgb, var(--dsw-alias-label-primary) 12%, transparent), 0 32px 72px color-mix(in srgb, var(--dsw-alias-label-primary) 16%, transparent);border-radius:16px;flex-direction:column;animation:.18s ease-out AryulW_agentTeamsPanelIn;display:flex;position:fixed;overflow:hidden}@keyframes AryulW_agentTeamsPanelIn{0%{opacity:0;transform:translateY(-6px)scale(.99)}to{opacity:1;transform:translateY(0)scale(1)}}@keyframes AryulW_agentTeamsPulse{0%,to{opacity:.42}50%{opacity:1}}.AryulW_panelHead{border-bottom:1px solid var(--dsw-alias-line-normal);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:0 14px 0 16px;display:flex}.AryulW_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.AryulW_closeButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,color .12s,transform .12s;display:inline-flex}.AryulW_closeButton:hover{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-primary)}.AryulW_closeButton:active{transform:scale(.94)}.AryulW_teams{overscroll-behavior:contain;flex-direction:column;min-height:0;display:flex;overflow-y:auto}.AryulW_team{border-bottom:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:12px;padding:12px 14px 16px;display:flex}.AryulW_team:last-child{border-bottom:0}.AryulW_teamHead{align-items:center;gap:10px;min-width:0;display:flex}.AryulW_teamName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:600;line-height:18px;overflow:hidden}.AryulW_teamStats{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;gap:8px;font-size:10.5px;line-height:16px;display:inline-flex}.AryulW_sectionHead{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}.AryulW_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:11px;font-weight:600;line-height:16px;display:inline-flex}.AryulW_sectionHint{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.AryulW_delegationSection{min-width:0}.AryulW_captainNode{box-sizing:border-box;border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 32%, var(--dsw-alias-line-normal));background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, var(--dsw-alias-bg-module));border-radius:10px;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:9px;min-height:48px;padding:8px 10px;display:grid}.AryulW_captainAvatar,.AryulW_memberAvatar{flex:none;justify-content:center;align-items:center;display:inline-flex;position:relative}.AryulW_captainAvatar{width:36px;height:36px}.AryulW_leadAvatar,.AryulW_memberArt,.AryulW_memberInitial{box-sizing:border-box;border:1px solid var(--dsw-alias-line-strong);object-fit:cover;background:#0b1d33;border-radius:50%;width:34px;height:34px}.AryulW_captainInfo,.AryulW_memberInfo{flex-direction:column;min-width:0;display:flex}.AryulW_captainInfo{gap:2px}.AryulW_captainLine,.AryulW_memberLine{align-items:center;gap:6px;min-width:0;display:flex}.AryulW_captainName,.AryulW_memberName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;font-weight:600;line-height:18px;overflow:hidden}.AryulW_captainRole,.AryulW_memberRole{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.AryulW_captainSummary,.AryulW_memberStatusLine{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;line-height:15px;overflow:hidden}.AryulW_captainState,.AryulW_memberState{color:var(--dsw-alias-label-tertiary);white-space:nowrap;flex:none;align-items:center;gap:5px;font-size:10px;font-weight:500;line-height:15px;display:inline-flex}.AryulW_captainState[data-busy=true],.AryulW_memberState[data-activity=working]{color:var(--dsw-alias-state-business-primary)}.AryulW_delegationTree{flex-direction:column;gap:2px;margin-left:18px;padding:9px 0 0 20px;display:flex;position:relative}.AryulW_delegationTree:before{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));content:\"\";width:1px;position:absolute;top:0;bottom:22px;left:0}.AryulW_memberBlock{flex-direction:column;min-width:0;padding:3px 0 7px;display:flex;position:relative}.AryulW_memberBranch{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 48%, var(--dsw-alias-line-normal));width:20px;height:1px;display:block;position:absolute;top:23px;right:100%}.AryulW_memberBranch:before{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;width:5px;height:5px;position:absolute;top:-2px;right:-1px}.AryulW_memberRow{box-sizing:border-box;width:100%;min-width:0;min-height:44px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:38px minmax(0,1fr) auto;align-items:center;gap:8px;padding:4px 6px;transition:background-color .12s,transform .12s;display:grid}.AryulW_memberRow:hover,.AryulW_memberRow[data-activity=working]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module))}.AryulW_memberRow:active{transform:scale(.995)}.AryulW_memberAvatar{width:34px;height:34px}.AryulW_memberAvatar[data-unread=true]:after{border:1px solid var(--dsw-alias-state-business-primary);content:\"\";border-radius:50%;animation:1.5s ease-out infinite AryulW_agentTeamsRing;position:absolute;inset:-3px}@keyframes AryulW_agentTeamsRing{0%{opacity:.82;transform:scale(.94)}75%,to{opacity:0;transform:scale(1.18)}}.AryulW_memberInitial{color:var(--dsw-alias-label-on-fill);justify-content:center;align-items:center;font-size:14px;font-weight:600;line-height:20px;display:inline-flex}.AryulW_stateArt{box-sizing:border-box;border:2px solid var(--dsw-alias-bg-module-platform);object-fit:cover;background:#0b1d33;border-radius:50%;width:19px;height:19px;position:absolute;bottom:-4px;right:-4px}.AryulW_stateArt[data-activity=working]{animation:2.4s ease-in-out infinite AryulW_agentTeamsFloat}.AryulW_stateArt[data-activity=idle]{animation:4.2s ease-in-out infinite AryulW_agentTeamsBreathe}.AryulW_stateArt[data-activity=unknown]{animation:2.8s ease-in-out infinite AryulW_agentTeamsThink}@keyframes AryulW_agentTeamsFloat{0%,to{transform:translateY(0)rotate(-4deg)}50%{transform:translateY(-2px)rotate(4deg)}}@keyframes AryulW_agentTeamsBreathe{0%,to{opacity:.82;transform:scale(1)}50%{opacity:1;transform:scale(1.06)}}@keyframes AryulW_agentTeamsThink{0%,to{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}.AryulW_memberState{margin-left:auto}.AryulW_memberCount{color:var(--dsw-alias-label-tertiary);font-size:10.5px;line-height:16px}.AryulW_assignmentLine{align-items:center;gap:7px;min-width:0;padding:0 6px 0 52px;display:flex}.AryulW_assignmentLabel{color:var(--dsw-alias-label-tertiary);flex:none;font-size:9.5px;line-height:14px}.AryulW_assignmentTasks{flex-wrap:wrap;flex:1;gap:4px;min-width:0;display:flex}.AryulW_assignmentChip{background:var(--dsw-alias-bg-fill-neutral);min-height:16px;color:var(--dsw-alias-label-secondary);border-radius:4px;align-items:center;padding:0 5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;font-weight:600;line-height:14px;display:inline-flex}.AryulW_assignmentChip[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.AryulW_assignmentChip[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.AryulW_assignmentChip[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.AryulW_assignmentChip[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.AryulW_assignmentChip[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.AryulW_unreadPill{color:var(--dsw-alias-state-business-primary);white-space:nowrap;flex:none;font-size:9.5px;font-weight:600;line-height:14px}.AryulW_taskEmpty{color:var(--dsw-alias-label-tertiary);font-size:9.5px;line-height:14px}.AryulW_dependencySection{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:7px;min-width:0;padding-top:10px;display:flex}.AryulW_stageFlow{scrollbar-width:thin;align-items:stretch;gap:0;min-width:0;padding:1px 1px 5px;display:flex;overflow-x:auto}.AryulW_stageGroup{flex:1 0 126px;min-width:126px;display:flex;position:relative}.AryulW_stageConnector{width:22px;height:14px;color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;margin-top:0;display:flex}.AryulW_stageLine{background:var(--dsw-alias-line-strong);flex:1;height:1px;display:block}.AryulW_stageColumn{flex-direction:column;flex:1;gap:5px;min-width:0;display:flex}.AryulW_stageLabel{color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;gap:6px;padding:0 2px;font-size:9.5px;font-weight:600;line-height:14px;display:flex}.AryulW_stageLabel span{background:var(--dsw-alias-bg-fill-neutral);border-radius:4px;justify-content:center;align-items:center;min-width:14px;height:14px;font-size:8.5px;display:inline-flex}.AryulW_stageTasks{flex-direction:column;gap:5px;display:flex}.AryulW_taskNode{box-sizing:border-box;border:1px solid var(--dsw-alias-line-normal);background:var(--dsw-alias-bg-module);min-width:0;min-height:72px;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;cursor:pointer;border-radius:8px;flex-direction:column;gap:4px;padding:7px 8px;transition:border-color .14s,opacity .14s,transform .12s,background-color .14s;display:flex}.AryulW_taskNode:hover,.AryulW_taskNode[data-focused=true]{border-color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, var(--dsw-alias-bg-module));transform:translateY(-1px)}.AryulW_taskNode[data-dimmed=true]{opacity:.34}.AryulW_taskNode[data-state=completed]{border-color:color-mix(in srgb, var(--dsw-alias-state-success) 48%, var(--dsw-alias-line-normal))}.AryulW_taskNode[data-state=blocked]{border-color:color-mix(in srgb, var(--dsw-alias-state-warning) 52%, var(--dsw-alias-line-normal))}.AryulW_taskNode[data-state=failed]{border-color:color-mix(in srgb, var(--dsw-alias-state-danger) 56%, var(--dsw-alias-line-normal))}.AryulW_taskNodeHead,.AryulW_taskRoute{justify-content:space-between;align-items:center;gap:5px;min-width:0;display:flex}.AryulW_taskId{color:var(--dsw-alias-label-tertiary);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9.5px;font-weight:700}.AryulW_taskBadge{background:var(--dsw-alias-bg-fill-neutral);min-height:14px;color:var(--dsw-alias-label-secondary);border-radius:4px;flex:none;align-items:center;padding:0 4px;font-size:8.5px;font-weight:600;line-height:13px;display:inline-flex}.AryulW_taskBadge[data-state=running]{background:var(--dsw-alias-bg-fill-business);color:var(--dsw-alias-label-on-fill)}.AryulW_taskBadge[data-state=completed]{background:var(--dsw-alias-bg-fill-success);color:var(--dsw-alias-label-on-fill)}.AryulW_taskBadge[data-state=blocked]{background:var(--dsw-alias-bg-fill-warning);color:var(--dsw-alias-label-on-fill)}.AryulW_taskBadge[data-state=failed]{background:var(--dsw-alias-bg-fill-danger);color:var(--dsw-alias-label-on-fill)}.AryulW_taskBadge[data-state=cancelled]{color:var(--dsw-alias-label-tertiary);text-decoration:line-through}.AryulW_taskSubject{min-height:30px;color:var(--dsw-alias-label-primary);-webkit-line-clamp:2;-webkit-box-orient:vertical;font-size:10.5px;font-weight:500;line-height:15px;display:-webkit-box;overflow:hidden}.AryulW_taskRoute{color:var(--dsw-alias-label-tertiary);margin-top:auto;font-size:8.5px;line-height:13px}.AryulW_taskOwner,.AryulW_taskDeps{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.AryulW_taskOwner{max-width:48%;color:var(--dsw-alias-label-secondary);font-weight:600}.AryulW_taskDeps{text-align:right;flex:1}.AryulW_taskStart{color:var(--dsw-alias-label-tertiary)}.AryulW_unclaimed,.AryulW_inbox{border-top:1px solid var(--dsw-alias-line-normal);flex-direction:column;gap:5px;min-width:0;padding-top:10px;display:flex}.AryulW_unclaimedTitle{color:var(--dsw-alias-label-secondary);font-size:10.5px;font-weight:600;line-height:15px}.AryulW_inboxRow{border-radius:6px;grid-template-columns:112px minmax(0,1fr);align-items:center;gap:8px;min-width:0;min-height:24px;padding:2px 5px;display:grid}.AryulW_inboxRow:hover{background:var(--dsw-alias-bg-module)}.AryulW_inboxRoute{min-width:0;color:var(--dsw-alias-state-business-primary);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:3px;font-size:9.5px;font-weight:600;line-height:14px;display:inline-flex;overflow:hidden}.AryulW_inboxContent{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:10px;line-height:14px;overflow:hidden}.AryulW_emptyHint{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:11px;line-height:16px}.AryulW_team[data-historic],.AryulW_archivedWrap{opacity:.82}.AryulW_historicPill{background:var(--dsw-alias-bg-fill-neutral);color:var(--dsw-alias-label-tertiary);border-radius:4px;flex:none;margin-left:auto;padding:1px 7px;font-size:9.5px;font-weight:600;line-height:15px}.AryulW_members{flex-direction:column;gap:3px;display:flex}.AryulW_archivedWrap:before{color:var(--dsw-alias-label-tertiary);content:\"已结束 · 历史归档\";padding:5px 14px 0;font-size:9.5px;font-weight:600;line-height:14px;display:block}@media (prefers-reduced-motion:reduce){[data-phase=active],.AryulW_panel,.AryulW_badge,.AryulW_badgeDot,.AryulW_panelDot,.AryulW_stateArt,.AryulW_memberAvatar[data-unread=true]:after{transition:none;animation:none}}@media (width<=960px){html{--agent-teams-main-shift:0px}html[data-agent-teams-panel-open] [data-phase=active]{padding-right:0}}@media (width<=640px){html{--agent-teams-panel-right:calc(10px + var(--dsh-sidebar-width,0px))}.AryulW_panel{width:auto;max-height:calc(100dvh - 68px);top:56px;left:10px}.AryulW_badge{top:56px}.AryulW_teamStats span[data-stat=messages]{display:none}.AryulW_captainNode{grid-template-columns:38px minmax(0,1fr)}.AryulW_captainState{display:none}.AryulW_delegationTree{margin-left:12px;padding-left:15px}.AryulW_memberBranch{width:15px}.AryulW_assignmentLine{padding-left:45px}}";
		...
		var ActivityPanel_module_css_default = {
			"agentTeamsBreathe": "AryulW_agentTeamsBreathe",
			"agentTeamsFloat": "AryulW_agentTeamsFloat",
			"agentTeamsPanelIn": "AryulW_agentTeamsPanelIn",
			"agentTeamsPulse": "AryulW_agentTeamsPulse",
			"agentTeamsRing": "AryulW_agentTeamsRing",
			"agentTeamsThink": "AryulW_agentTeamsThink",
			"archivedWrap": "AryulW_archivedWrap",
			"assignmentChip": "AryulW_assignmentChip",
			"assignmentLabel": "AryulW_assignmentLabel",
			"assignmentLine": "AryulW_assignmentLine",
			"assignmentTasks": "AryulW_assignmentTasks",
			"badge": "AryulW_badge",
			"badgeCount": "AryulW_badgeCount",
			"badgeDot": "AryulW_badgeDot",
			"captainAvatar": "AryulW_captainAvatar",
			"captainInfo": "AryulW_captainInfo",
			"captainLine": "AryulW_captainLine",
			"captainName": "AryulW_captainName",
			"captainNode": "AryulW_captainNode",
			"captainRole": "AryulW_captainRole",
			"captainState": "AryulW_captainState",
			"captainSummary": "AryulW_captainSummary",
			"closeButton": "AryulW_closeButton",
			"delegationSection": "AryulW_delegationSection",
			"delegationTree": "AryulW_delegationTree",
			"dependencySection": "AryulW_dependencySection",
			"emptyHint": "AryulW_emptyHint",
			"historicPill": "AryulW_historicPill",
			"inbox": "AryulW_inbox",
			"inboxContent": "AryulW_inboxContent",
			"inboxRoute": "AryulW_inboxRoute",
			"inboxRow": "AryulW_inboxRow",
			"leadAvatar": "AryulW_leadAvatar",
			"memberArt": "AryulW_memberArt",
			"memberAvatar": "AryulW_memberAvatar",
			"memberBlock": "AryulW_memberBlock",
			"memberBranch": "AryulW_memberBranch",
			"memberCount": "AryulW_memberCount",
			"memberInfo": "AryulW_memberInfo",
			"memberInitial": "AryulW_memberInitial",
			"memberLine": "AryulW_memberLine",
			"memberName": "AryulW_memberName",
			"memberRole": "AryulW_memberRole",
			"memberRow": "AryulW_memberRow",
			"memberState": "AryulW_memberState",
			"memberStatusLine": "AryulW_memberStatusLine",
			"members": "AryulW_members",
			"panel": "AryulW_panel",
			"panelDot": "AryulW_panelDot",
			"panelHead": "AryulW_panelHead",
			"panelTitle": "AryulW_panelTitle",
			"sectionHead": "AryulW_sectionHead",
			"sectionHint": "AryulW_sectionHint",
			"sectionTitle": "AryulW_sectionTitle",
			"stageColumn": "AryulW_stageColumn",
			"stageConnector": "AryulW_stageConnector",
			"stageFlow": "AryulW_stageFlow",
			"stageGroup": "AryulW_stageGroup",
			"stageLabel": "AryulW_stageLabel",
			"stageLine": "AryulW_stageLine",
			"stageTasks": "AryulW_stageTasks",
			"stateArt": "AryulW_stateArt",
			"taskBadge": "AryulW_taskBadge",
			"taskDeps": "AryulW_taskDeps",
			"taskEmpty": "AryulW_taskEmpty",
			"taskId": "AryulW_taskId",
			"taskNode": "AryulW_taskNode",
			"taskNodeHead": "AryulW_taskNodeHead",
			"taskOwner": "AryulW_taskOwner",
			"taskRoute": "AryulW_taskRoute",
			"taskStart": "AryulW_taskStart",
			"taskSubject": "AryulW_taskSubject",
			"team": "AryulW_team",
			"teamHead": "AryulW_teamHead",
			"teamName": "AryulW_teamName",
			"teamStats": "AryulW_teamStats",
			"teams": "AryulW_teams",
			"unclaimed": "AryulW_unclaimed",
			"unclaimedTitle": "AryulW_unclaimedTitle",
			"unreadPill": "AryulW_unreadPill"
		};
		//#endregion
