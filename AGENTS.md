...
- **Tailnet Web GUI** — `dsh web --tailscale` discovers this node's MagicDNS name and publishes loopback through `tailscale serve`; `DSH_TRUSTED_HOST` plugs in another hostname ([cookbook](docs/cookbook/tailscale-web.md)).
