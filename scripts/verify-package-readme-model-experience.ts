...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-sticky-disclosure': { kind: 'none', reason: 'Browser-side overlay that clicks existing disclosure toggles; collapsing a section never enters the Session log, model context, or telemetry.' },
